...
const common={
  '8 caractères minimum':{
    en:'8 characters minimum',de:'Mindestens 8 Zeichen',es:'8 caracteres mínimo',it:'Minimo 8 caratteri',pt:'Mínimo de 8 caracteres'
  },
  'Décris ce que l’application aurait dû faire...':{
    en:'Describe what the application should have done...',de:'Beschreibe, was die Anwendung hätte tun sollen...',es:'Describe lo que debería haber hecho la aplicación...',it:'Descrivi cosa avrebbe dovuto fare l’applicazione...',pt:'Descreve o que a aplicação deveria ter feito...'
  },
  'Nom, input, effet, CC, protection…':{
    en:'Name, input, effect, CC, protection…',de:'Name, Input, Effekt, CC, Schutz…',es:'Nombre, input, efecto, CC, protección…',it:'Nome, input, effetto, CC, protezione…',pt:'Nome, input, efeito, CC, proteção…'
  },
  'Répète le mot de passe':{
    en:'Repeat password',de:'Passwort wiederholen',es:'Repite la contraseña',it:'Ripeti la password',pt:'Repete a palavra-passe'
  }
};
const specific={
  de:{
